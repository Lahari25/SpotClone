...
def home_page():
    ...
    st.title('SpotClone Recommendation System')
...
def About_page():
    ...
    """
    Check out the [repository](https://github.com/Lahari25/SpotClone) for the source code and approaches, and don't hesitate to contact me if you have any questions. I'm excited to read your review.
    [Github](https://github.com/Lahari25)  [Linkedin](https://www.linkedin.com/in/lahariappala/) Email : 333lahari@gmail.com
    """
